                ...
                <div class="card">
                    ...
                    <ul class="nav nav-tabs" id="medicalTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="exam-tab" data-bs-toggle="tab" data-bs-target="#exam" type="button" role="tab">
                    ...
                    <form method="post" enctype="multipart/form-data" id="medicalForm">
                        <div class="tab-content" id="medicalTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group date" id="visit_date" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#visit_date" name="visit_date" required data-toggle="datetimepicker" autocomplete="off" />
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group date" id="next_visit_date" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#next_visit_date" name="next_visit_date" data-toggle="datetimepicker" autocomplete="off" />
                                ...
                                <div class="info-row">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                            ...
                                            <input type="number" id="weight" name="weight" class="form-control" required step="0.1" />
                                        </div>
                                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                            ...
                                            <input type="number" id="temperature" name="temperature" class="form-control" required step="0.1" />
                                        </div>
                                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                ...
                                <div class="medical-images">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="ultrasound" class="upload-box">
                                            <input type="file" id="ultrasound" name="ultrasound" accept="image/*" hidden>
                            ...
                            <div class="tab-pane fade" id="prescription" role="tabpanel">
                                <h5 class="section-title"><i class="fas fa-prescription-bottle-alt"></i> Kê đơn thuốc</h5>
...
<!-- cho tải ảnh -->
    ...
    $(document).ready(function() {
        ...
        $("#add_to_list").click(function() {
            ...
            if (medicineId && quantity && dosage) {
                ...
                if ($("#current_medicines_list tr").length == 1 && $("#current_medicines_list td").attr('colspan')) {
                ...
                tr += '<button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteCurrentRow(this);">';
        ...
        $('#medicalForm').on('submit', function(e) {
            ...
            var requiredFields = ['bp', 'weight', 'height', 'temperature', 'pulse', 'heart_rate', 'tc', 'cd', 'bienphap', 'disease', 'nv'];
    ...
    function deleteCurrentRow(obj) {
        ...
        if ($("#current_medicines_list tr").length === 0) {
            $("#current_medicines_list").html('<tr><td colspan="6" class="text-center text-muted py-4">Chưa có thuốc nào được thêm vào đơn</td></tr>');
        }
    }
    </script>
