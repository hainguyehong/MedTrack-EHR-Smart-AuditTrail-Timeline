                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    ...
                                    <input type="text" id="patient_name" name="patient_name" required="required"
                                        class="form-control form-control-sm" value="<?php echo $row['patient_name'];?>" readonly />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Địa chỉ</label>
                                    <input type="text" id="address" name="address" required="required"
                                        class="form-control form-control-sm" value="<?php echo $row['address'];?>" readonly />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>CCCD</label>
                                    <input type="text" id="cnic" name="cnic" required="required"
                                        class="form-control form-control-sm" value="<?php echo $row['cnic'];?>" readonly />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Ngày sinh</label>
                                    <input type="text" id="date_of_birth" name="date_of_birth" class="form-control form-control-sm" value="<?php echo (!empty($dob)) ? date('d/m/Y', strtotime($dob)) : ''; ?>" readonly />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Số điện thoại</label>
                                    <input type="text" id="phone_number" name="phone_number" required="required"
                                        class="form-control form-control-sm" value="<?php echo $row['phone_number'];?>" readonly />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
