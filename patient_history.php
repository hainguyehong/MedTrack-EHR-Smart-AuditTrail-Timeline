            ...
            <section class="content">
                ...
                <div class="card card-outline card-primary rounded-0 shadow">
                    <div class="card-header">
                        <h3 class="card-title">Tìm kiếm lịch sử bệnh nhân</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12">
                                <button type="button" id="search" class="btn btn-primary btn-sm btn-flat btn-block">Tìm
                                    kiếm</button>
                            </div>
                        </div>
                                ...
                                <table id="patient_history" class="table table-striped table-bordered">
                                    ...
                                    <thead>
                                        <tr class="bg-gradient-primary text-light">
                                            ...
                                            <th class="p-1 text-center">Bệnh Lý</th>
                                            <th class="p-1 text-center">Thuốc</th>
                                            <th class="p-1 text-center">Đóng gói</th>
                                            <th class="p-1 text-center">Số lượng</th>
                                            <th class="p-1 text-center">Liều lượng</th>
                                        </tr>
                                    </thead>
